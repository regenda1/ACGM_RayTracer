...
TEST(ShaderTests, PhongTestLight)
{
  ...
  acgm::PhongShader p = acgm::PhongShader(cogs::Color3f(1.0f, 0.0f, 0.0f), 2.0f, 0.2f, 0.5f, 1.0f, 0.0f, 0.0f, 0.0f);
...
TEST(ShaderTests, CheckerBoardShaderTestP1)
{
  ...
  std::shared_ptr <acgm::Shader> p1 = std::make_shared<acgm::PhongShader>(cogs::Color3f(1.0f, 0.0f, 0.0f), 2.0f, 0.2f, 0.5f, 1.0f, 0.0f, 0.0f, 0.0f);
  std::shared_ptr <acgm::Shader> p2 = std::make_shared<acgm::PhongShader>(cogs::Color3f(0.0f, 1.0f, 0.0f), 2.0f, 0.2f, 0.5f, 1.0f, 0.0f, 0.0f, 0.0f);
